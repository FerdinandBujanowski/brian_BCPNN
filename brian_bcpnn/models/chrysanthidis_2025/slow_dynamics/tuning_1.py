# SIMULATION PURPOSE: Get single intra-MC PYR-PYR EPSP to around 0.9 mV (at V_m=-70mV)
...
trains.get_full_train(ax1, spikemon, model.N, 2010*ms)
ax2.plot(volmon.t/ms, volmon[0].V_m/mV, label='neuron 0')
